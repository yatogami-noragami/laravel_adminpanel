            ...
            <div class=" col-lg-6 ">
                ...
                <div class="my-3">
                    ...
                    <select name="itemCondition" id="itemCondition"
                        ...
                        <option selected disabled>Select Item Condition</option>
                        <option value="New">New</option>
                        <option value="Used">Used</option>
                        <option value="Good Secondhand">Good Secondhand</option>
                    </select>
                ...
                <div class="my-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="publish" id="itemStatus" name="itemStatus">
            ...
            <div class="col-lg-6">
                ...
                <div class="my-3">
                    ...
                    <input type="text" class="form-control @error('itemOwnerName') is-invalid @enderror"
                        value="{{ old('itemOwnerName') }}" id="itemOwnerName" name="itemOwnerName"
                    ...
                    <div class="d-flex">
                        <select id="itemOwnerCountryCode" name="itemOwnerCountryCode" class=" form-select">
                            @foreach ($callingCodes as $callingCode)
                                <option value="{{ $callingCode }}" @if ($callingCode == '+95') selected @endif>
                                    {{ $callingCode }}</option>
                            @endforeach
                        </select>

                        <input type="tel" class="form-control @error('itemOwnerContactNumber') is-invalid @enderror"
                            value="{{ old('itemOwnerContactNumber') }}" id="itemOwnerContactNumber"
                ...
                <div class="my-3">
                    ...
                    <input type='text' class="form-control @error('itemOwnerAddress') is-invalid @enderror"
                        value="{{ old('itemOwnerAddress') }}" id="itemOwnerAddress" name="itemOwnerAddress"
